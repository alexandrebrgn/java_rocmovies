...
public class MovieSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (movieRepo.count() == 0) {
            movieRepo.save(new Movie("Cloud Atlas", 1, 2012,
                    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOTu-5AL00Gaj6NEip1WKCken0aP6VOdE2ew&s"));
            movieRepo.save(new Movie("Shutter Island", 2, 2010,
            ...
            movieRepo.save(new Movie("Inception", 1, 2010,
                    "https://media.tenor.com/nsQ57a43PG0AAAAM/funny-memes-woody.gif"));
            movieRepo.save(new Movie("The Matrix", 1, 1999,
                    "https://image.tmdb.org/t/p/w500/f89U3ADr1oiB1s9GkdPOEpXUk5H.jpg"));
            movieRepo.save(new Movie("The Dark Knight", 3, 2008,
                    "https://image.tmdb.org/t/p/w500/qJ2tW6WMUDux911r6m7haRef0WH.jpg"));
            movieRepo.save(new Movie("Fight Club", 4, 1999,
                    "https://image.tmdb.org/t/p/w500/bptfVGEQuv6vDTIMVCHjJ9Dz8PX.jpg"));
            movieRepo.save(new Movie("The Godfather", 4, 1972,
                    "https://image.tmdb.org/t/p/w500/3bhkrj58Vtu7enYsRolD1fZdja1.jpg"));
            movieRepo.save(new Movie("The Shawshank Redemption", 4, 1994,
                    "https://image.tmdb.org/t/p/w500/q6y0Go1tsGEsmtFryDOJo3dEmqu.jpg"));
            movieRepo.save(new Movie("Forrest Gump", 4, 1994,
                    "https://image.tmdb.org/t/p/w500/saHP97rTPS5eLmrLQEcANmKrsFl.jpg"));
            movieRepo.save(new Movie("The Silence of the Lambs", 2, 1991,
                    "https://image.tmdb.org/t/p/w500/rplLJ2hPcOQmkFhTqUte0MkEaO2.jpg"));
            movieRepo.save(new Movie("Se7en", 2, 1995,
                    "https://image.tmdb.org/t/p/w500/6yoghtyTpznpBik8EngEmJskVUO.jpg"));
            movieRepo.save(new Movie("Gladiator", 3, 2000,
                    "https://image.tmdb.org/t/p/w500/ty8TGRuvJLPUmAR1H1nRIsgwvim.jpg"));
            movieRepo.save(new Movie("Saving Private Ryan", 3, 1998,
                    "https://media.tenor.com/6Q-6vsQeJJIAAAAM/tigre-fumando.gif"));
            movieRepo.save(new Movie("The Prestige", 1, 2006,
                    "https://m.media-amazon.com/images/I/61pCWRdyhbL._AC_UF894,1000_QL80_.jpg"));
            movieRepo.save(new Movie("Memento", 2, 2000,
                    "https://image.tmdb.org/t/p/w500/fQMSaP88cf1nz4qwuNEEFtazuDM.jpg"));
            movieRepo.save(new Movie("Whiplash", 4, 2014,
                    "https://image.tmdb.org/t/p/w500/oPxnRhyAIzJKGUEdSiwTJQfDyyG.jpg"));
            movieRepo.save(new Movie("La La Land", 4, 2016,
                    "https://image.tmdb.org/t/p/w500/uDO8zWDcS3cRRvuI0XbbUAT4lO0.jpg"));
            movieRepo.save(new Movie("Parasite", 2, 2019,
                    "https://image.tmdb.org/t/p/w500/7IiTTgloJzvGI1TAYymCfbfl3vT.jpg"));
            movieRepo.save(new Movie("Joker", 4, 2019,
                    "https://image.tmdb.org/t/p/w500/udDclJoHjfjb8Ekgsd4FDteOkCU.jpg"));
            movieRepo.save(new Movie("Avengers: Endgame", 3, 2019,
                    "https://image.tmdb.org/t/p/w500/or06FN3Dka5tukK1e9sl16pB3iy.jpg"));
            movieRepo.save(new Movie("Iron Man", 3, 2008,
                    "https://image.tmdb.org/t/p/w500/78lPtwv72eTNqFW9COBYI0dWDJa.jpg"));
            movieRepo.save(new Movie("Doctor Strange", 1, 2016,
                    "https://image.tmdb.org/t/p/w500/4PiiNGXj1KENTmCBHeN6Mskj2Fq.jpg"));
            movieRepo.save(new Movie("Black Panther", 3, 2018,
                    "https://image.tmdb.org/t/p/w500/uxzzxijgPIY7slzFvMotPv8wjKA.jpg"));
            movieRepo.save(new Movie("The Wolf of Wall Street", 4, 2013,
                    "https://image.tmdb.org/t/p/w500/pWHf4E2fOelpq0sxod9Q7IuZQG7.jpg"));
            movieRepo.save(new Movie("The Revenant", 3, 2015,
                    "https://image.tmdb.org/t/p/w500/oXUWEc5i3wYyFnL1Ycu8ppxxPvs.jpg"));
            movieRepo.save(new Movie("Django Unchained", 3, 2012,
                    "https://image.tmdb.org/t/p/w500/7oWY8VDWW7thTzWh3OKYRkWUlD5.jpg"));
            movieRepo.save(new Movie("The Hateful Eight", 2, 2015,
                    "https://image.tmdb.org/t/p/w500/fqe8JxDNO8B8QfOGTdjhPK4F2ak.jpg"));
            movieRepo.save(new Movie("Blade Runner 2049", 1, 2017,
                    "https://image.tmdb.org/t/p/w500/gajva2L0rPYkEWjzgFlBXCAVBE5.jpg"));
            movieRepo.save(new Movie("Arrival", 1, 2016,
                    "https://image.tmdb.org/t/p/w500/x2FJsf1ElAgr63Y3PNPtJcuk9qC.jpg"));
            movieRepo.save(new Movie("Mad Max: Fury Road", 3, 2015,
                    "https://image.tmdb.org/t/p/w500/8tZYtuWezp8JbcsvHYO0O46tFbo.jpg"));
            movieRepo.save(new Movie("The Social Network", 4, 2010,
                    "https://image.tmdb.org/t/p/w500/n0ybibhJtQ5icDqTp8eRytcIHJx.jpg"));
            movieRepo.save(new Movie("The Grand Budapest Hotel", 4, 2014,
